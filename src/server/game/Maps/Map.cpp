...
void Map::Update(uint32 t_diff)
{
    ...
    for (m_mapRefIter = m_mapRefManager.begin(); m_mapRefIter != m_mapRefManager.end(); ++m_mapRefIter)
    {
        ...
        { // Update any creatures that own auras the player has applications of
            ...
            // Optimize iteration over player applied auras by using structured binding by const reference.
            // Avoids creating temporary std::pair<uint32, AuraApplication*> objects and pair value copies on every tick.
