...
class TC_GAME_API Map : public GridRefManager<NGridType>
{
    ...
    private:
        ...
        // Reusable scratchpad containers for Map::Update to avoid heap allocation churn.
        // These are strictly for temporary use in the Map::Update method and do not represent persistent state.
